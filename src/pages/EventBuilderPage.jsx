...
export default function EventBuilderPage({ setCurrentPage }) {
  ...
  return (
    <div className="event-builder-page" style={{ padding: "225px 0 60px 0", backgroundColor: "#f7f4ef", minHeight: "100vh", fontFamily: "'Jost', sans-serif" }}>
          ...
          {Array.from({ length: stepsCount }, (_, idx) => idx + 1).map(num => (
            <div 
              ...
              style={{
                ...
                height: "32px",
                borderRadius: "50%",
                backgroundColor: step >= num ? "var(--navy)" : "white",
                color: step >= num ? "white" : "var(--navy)",
                border: step >= num ? "2px solid var(--navy)" : "2px solid var(--border)",
                display: "flex",
                alignItems: "center",
